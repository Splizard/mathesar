...
urlpatterns = [
    ...
    path('administration/users/<uuid:user_id>/', views.admin_home, name='admin_users_edit'),
    ...
    path('files/<slug:download_link_hmac>/download/', views.download_link.download_file, name='files_download'),
    path('files/<slug:download_link_hmac>/thumbnail/', views.download_link.load_file_thumbnail, name='files_thumbnail'),
    path('files/<slug:download_link_hmac>/', views.download_link.load_file, name='files_direct'),
